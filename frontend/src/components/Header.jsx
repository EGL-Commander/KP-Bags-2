        ...
        <div className="max-w-7xl mx-auto flex flex-wrap justify-center sm:justify-between items-center gap-x-3 gap-y-1.5 sm:gap-2">
          ...
          <div className="flex items-center gap-3 sm:gap-4 flex-shrink-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-white hover:text-green-400 transition-all duration-300 hover:scale-110 flex-shrink-0"
              title="WhatsApp"
            >
              <svg
                className="w-3.5 h-3.5 sm:w-4 sm:h-4 fill-current"
                viewBox="0 0 24 24"
              >
                <path d="M20.52 3.48A11.86 11.86 0 0012.06 0C5.45 0 .08 5.37.08 11.98c0 2.11.55 4.17 1.59 5.99L0 24l6.2-1.63a11.92 11.92 0 005.86 1.49h.01c6.61 0 11.98-5.37 11.98-11.98 0-3.2-1.25-6.2-3.53-8.4zM12.07 21.8a9.83 9.83 0 01-5.01-1.37l-.36-.21-3.68.97.98-3.58-.23-.37a9.82 9.82 0 01-1.51-5.26c0-5.42 4.41-9.83 9.84-9.83 2.63 0 5.1 1.02 6.95 2.88a9.76 9.76 0 012.88 6.95c0 5.43-4.41 9.82-9.86 9.82zm5.39-7.37c-.3-.15-1.77-.87-2.04-.97-.27-.1-.47-.15-.67.15-.2.3-.77.97-.95 1.17-.17.2-.35.22-.65.07-.3-.15-1.26-.46-2.4-1.48-.88-.78-1.48-1.75-1.65-2.05-.17-.3-.02-.46.13-.61.13-.13.3-.35.45-.52.15-.17.2-.3.3-.5.1-.2.05-.37-.03-.52-.08-.15-.67-1.62-.92-2.22-.24-.58-.49-.5-.67-.51h-.57c-.2 0-.52.08-.8.38-.27.3-1.05 1.03-1.05 2.52s1.08 2.93 1.23 3.13c.15.2 2.11 3.22 5.11 4.52.71.31 1.27.49 1.71.63.72.23 1.37.2 1.89.12.58-.09 1.77-.72 2.02-1.42.25-.7.25-1.3.17-1.42-.08-.12-.28-.2-.58-.35z" />
              </svg>
            </a>
          </div>
        </div>
