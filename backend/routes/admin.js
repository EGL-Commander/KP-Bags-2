...
const defaultGalleryItems = [
  { type: 'bags', title: 'Type-A Standard FIBC Bags', desc: 'Heavy-duty 1000kg load capacity standard bags stored in warehouse.', src: '/public/fibc-type-a.jpeg', alt: 'Type-A standard FIBC jumbo bag' },
  { type: 'bags', title: 'Baffle Q-Bags Stack', desc: 'Baffle bags maintaining neat square profiles under test loads.', src: '/public/baffle-bag.jpeg', alt: 'Baffle FIBC Q-bag diagram' },
  { type: 'bags', title: 'Ventilated Agricultural Bags', desc: 'Ventilated FIBC bags packed with crops showing breathability strips.', src: '/public/Ventilated Agricultural Bags.png', alt: 'Ventilated mesh FIBC bags' },
  { type: 'factory', title: 'High-Speed Circular Looms', desc: 'Weaving area with circular looms running PP spools continuously.', src: '/public/high-speed-circular-loom.jpg', alt: 'High-speed circular looms' },
  { type: 'factory', title: 'Tape Extrusion Extruder', desc: 'Polypropylene melt extrusion and slitting line winding tape rolls.', src: '/public/Tape Extrusion Extruder.png', alt: 'Tape extrusion line' },
  { type: 'factory', title: 'Positive Pressure Sew Block', desc: 'Cleanroom sewing lines with HEPA filtration and personnel hoods.', src: '/public/Positive Pressure Sew Block.png', alt: 'Cleanroom sewing line' },
  { type: 'testing', title: 'Tensile Strength Test Bench', desc: 'Calibrated electronic mechanical tester testing loop seam breakage.', src: '/public/Tensile Strength Test Bench.png', alt: 'Tensile strength testing' },
  { type: 'testing', title: 'UV Weather-Ometer Cabinet', desc: 'Accelerated solar exposure chambers testing fabric UV retention.', src: '/public/UV Weather-Ometer Cabinet.png', alt: 'UV weather-ometer' },
  { type: 'shipping', title: 'Container Stuffing Dock', desc: 'Loading pallets of vacuum-compressed jumbo bags into export containers.', src: '/public/Container Stuffing Dock.png', alt: 'Container stuffing' }
];
